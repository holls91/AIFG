...
//		Work out the distance to target
		Vector direction = evadeTarget.getPosition().subtract(getCharacter().getPosition());
...
//		Position sarebbe la posizione dell'explicitTarget
		...
		position = position.add(evadeTarget.getVelocity().multiply(prediction));
